...
function startSelectionSort() {
    ...
    let arr = createArray(length);//size of array
    selectionSort(arr, states);//it adds the number of states [array, orderIndex, curCompareIndex, curMinIndex]
    ...
    for (let i = 0; i < states.length; i++) {
        timer.push(setTimeout(
            ...
            states[i][1],
             states[i][2], 
             states[i][3]));//invokes drawselect() method
    }
}
